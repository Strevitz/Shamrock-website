...
const About = () => {
  return (
    <div className="page">
      <Hero hero="roomsHero">
        <Banner title="Polityka Prywatności"></Banner>
      </Hero>
      <section className="services">
        <Title title="Polityka prywatności i Plików Cookies" />
        ...
        <article>
          ...
          <p>
            ...
            url: <b>shamrockbarber.com</b>. Operatorem serwisu oraz
            ...
            usług Prezentacja oferty lub informacji Serwis realizuje funkcje
          ...
          <p>
            ...
            serwerze. Operator okresowo zmienia swoje hasła administracyjne. W
            celu ochrony danych Operator regularnie wykonuje kopie
            bezpieczeństwa. Istotnym elementem ochrony danych jest regularna
          ...
          <p>
            ...
            Administratorze. Dotyczy to takich grup odbiorców: kurierzy
            operatorzy pocztowi operatorzy rozwiązania typu chat online
            upoważnieni pracownicy i współpracownicy, którzy korzystają z danych
            w celu realizacji celu działania strony firmy, świadczące usługi
            marketingu na rzecz Administratora Twoje dane osobowe przetwarzane
            ...
            prawo żądania od Administratora: dostępu do danych osobowych Ciebie
            dotyczących, ich sprostowania, usunięcia, ograniczenia
            przetwarzania, oraz przenoszenia danych. Przysługuje Ci prawo do
            złożenia sprzeciwu w zakresie przetwarzania wskazanego w pkt 3.3 c/
            wobec przetwarzania danych osobowych w celu wykonania prawnie
            ...
            roszczeń. Na działania Administratora przysługuje skarga do Prezesa
